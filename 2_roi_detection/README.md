...
```bash
python3 object_tracking.py --name="../inputs/Validatietaak.mp4" --label="stoplicht" --start_frame=70
```
...
```bash
python3 roi_selection.py --name="../inputs/Validatietaak.mp4" --label="stoplicht" --start-frame=100
```
